        ...
        init: function(options) {
            ...
            $(this).each(function() {
                ...
                if (options.edge == "left") {
                    ...
                    menu.addClass("right-aligned").css("transform", "translateX(100%)","-webkit-transform", "translateX(100%)");
                    $dragTarget.css({
                        right: 0
                    })
                }
                ...
                if (options.closeOnClick === true) {
                    menu.on("click.itemclick", "a:not(.collapsible-header)", function() {
                        if (!(window.innerWidth > 1024 && menu.hasClass("fixed"))) {
                            removeMenu()
                        }
                    })
                }
                    ...
                    $dragTarget.hammer({
                        ...
                        if (e.gesture.pointerType == "touch") {
                            ...
                            if (options.edge === "left") {
                                ...
                                menu.css("-webkit-transform", "translateX(" + (x - options.menuWidth) + "%)")
                            } else {
                                ...
                                menu.css("-webkit-transform", "translateX(" + rightPos + "%)")
                            }
                            var overlayPerc;
                            if (options.edge === "left") {
